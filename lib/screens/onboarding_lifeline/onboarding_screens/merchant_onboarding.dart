...
class MerchantOnboarding extends StatefulWidget {
  final String title;
  const MerchantOnboarding({super.key, required this.title});

  @override
  _MerchantOnboardingState createState() => _MerchantOnboardingState();
}
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () async {
                            if (_formKey.currentState!.validate()) {
                              ...
                              bool result = await AuthService().merchantOnboard(
                                  fullName!,
                                  email!,
                                  phoneNumber!,
                                  businessName!,
