...
class FranchiseTeamScreen extends StatefulWidget {
  const FranchiseTeamScreen({super.key});

  @override
  State<FranchiseTeamScreen> createState() => _FranchiseTeamScreenState();
}

class _FranchiseTeamScreenState extends State<FranchiseTeamScreen> {
  @override
                    ...
                    children: [
                      ...
                      Expanded(
                        ...
                        child: Column(
                          ...
                          children: [
                            _buildStatRow(
                                "Total Frenchise Team", "324", Colors.blue),
                            _buildStatRow(
                                "Frenchise Team Lead", "43524", Colors.orange),
                            _buildStatRow("Frenchise Team Earning", "253375",
                                Colors.green),
                          ],
                        ),
                      ),
